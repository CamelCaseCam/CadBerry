...
public abstract class ConverterFilter<T,C> {
    public abstract boolean passes(final T object);
    public abstract C convert(final T object);
    ...
    public abstract class SimpleCast extends ConverterFilter {
        @Override
    ...
    private class FilterIterator implements Iterator<C> {
